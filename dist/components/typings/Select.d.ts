...
export declare type SingleSelected = number | string;
export declare type MultiSelected = Array<number | string>;
...
export interface MultiSelectProps<OptionType> extends CommonSelectProps<OptionType> {
    multiSelect: true;
    onChange: (value: OptionType[], extras: Extras) => void;
